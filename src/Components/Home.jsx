...
const Home = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      >
        <div
          className="relative w-full h-64 sm:h-72 md:h-80 lg:h-96 overflow-hidden rounded-xl mb-12 bg-gray-900 text-gray-300"
          onMouseEnter={handlePause}
          onMouseLeave={handleResume}
        >
          {/* Slide List */}
          <ul
            ref={slideRef}
            className="flex w-full h-full overflow-x-auto scroll-smooth snap-x snap-mandatory whitespace-nowrap"
          >
